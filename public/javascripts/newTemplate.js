...
function bindSlideEvent(){
  ...
  for(let i=0;i<slides.length;i++){
    slides[i].onclick = function(){
      ...
      switch (i) {
      case 0:
        location.href= '/pcmall/list?cat_id=45'
        break
      case 1:
        location.href= '/pcmall/list?cat_id=55'
        break
      case 2:
        location.href= '/pcmall/list?cat_id=62'
        break
      case 3:
        location.href= '/pcmall/list?cat_id=69'
        break
      case 4:
        location.href= '/pcmall/list?cat_id=77'
        break
      case 5:
        location.href= '/pcmall/list?cat_id=82'
        break
      case 6:
        location.href= '/pcmall/list?cat_id=92'
        break
      case 9:
        location.href= '/pcmall/list?cat_id=125'
        break
      default:
